...
const navbar = (
  <Navbar
    logo={<b>Univoice</b>}
    projectLink="https://github.com/shenjingnan/univoice"
...
const footer = (
  <Footer>MIT {new Date().getFullYear()} © Univoice.</Footer>
);
    ...
    >
      ...
      <body>
        <Layout
          ...
          docsRepositoryBase="https://github.com/shenjingnan/univoice/tree/main/docs"
          footer={footer}
