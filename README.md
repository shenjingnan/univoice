...
|--------|---------|-----|-----|--------|
| 豆包 | 0ms | 0ms | 0ms | 0% |
| 通义千问 | 1462ms | 1526ms | 2098ms | 100% |
| MiniMax | 1115ms | 1099ms | 1626ms | 100% |
| 智谱 GLM | 1136ms | 1049ms | 1552ms | 100% |
...
| 提供商 | 平均延迟 | P50 | P95 | 成功率 |
|--------|---------|-----|-----|--------|
| 通义千问 | 1846ms | 1737ms | 2547ms | 100% |
| MiniMax | 1555ms | 1497ms | 2539ms | 100% |
| 智谱 GLM | 1717ms | 1548ms | 3662ms | 100% |
...
| 场景 | 推荐提供商 | 原因 |
|------|-----------|------|
| LLM 实时对话 | MiniMax | 最低首包延迟 (1555ms) |
