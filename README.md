...
|--------|------|------|----------|-------------|----------|---------------|---------------|----------|----------|-------------|-----|
| 通义千问 | paraformer-realtime-v2 | zh-CN | pcm | 16000 | 6 | **1048 🏆** | *81* | **1197 🏆** | **1287 🏆** | **128 🏆** | **1.33 🏆** |
| 通义千问 | paraformer-realtime-v1 | zh-CN | pcm | 16000 | 6 | *1285* | **25 🏆** | *1235* | *2007* | *532* | *1.52* |
